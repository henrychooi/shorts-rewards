    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('session_id', models.CharField(blank=True, help_text='Unique session identifier', max_length=64)),
        ...
        migrations.AddIndex(
            model_name='view',
            index=models.Index(fields=['user', 'short'], name='api_view_user_id_915648_idx'),
        ),
        migrations.AddIndex(
            model_name='view',
            index=models.Index(fields=['session_id'], name='api_view_session_70de3a_idx'),
        ),
        migrations.AddIndex(
            model_name='view',
            index=models.Index(fields=['watch_percentage'], name='api_view_watch_p_ee1a60_idx'),
        ),
        migrations.AlterUniqueTogether(
            name='view',
